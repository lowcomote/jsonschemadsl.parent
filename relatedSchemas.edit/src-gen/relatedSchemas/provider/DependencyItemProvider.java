...
/**
 * This is the item provider adapter for a {@link relatedSchemas.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Dependency_dependency_feature",
								"_UI_Dependency_type"),
						RelatedSchemasPackage.Literals.DEPENDENCY__DEPENDENCY, true, false, true, null, null, null));
	}
	...
	protected void addPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dependency_property_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dependency_property_feature",
								"_UI_Dependency_type"),
						RelatedSchemasPackage.Literals.DEPENDENCY__PROPERTY, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Dependency) object).getProperty();
