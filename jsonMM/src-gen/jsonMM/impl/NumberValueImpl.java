 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMM.impl.NumberValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberValueImpl extends ValueImpl implements NumberValue {
	...
	protected EClass eStaticClass() {
		return JsonMMPackage.Literals.NUMBER_VALUE;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMMPackage.NUMBER_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JsonMMPackage.NUMBER_VALUE__VALUE:
			return getValue();
		}
