 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.MaxLengthSchemaDefinitionImpl#getMaxLength <em>Max Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaxLengthSchemaDefinitionImpl extends KeywordDefinitionImpl implements MaxLengthSchemaDefinition {
	...
	public NotificationChain basicSetMaxLength(NonNegativeInteger newMaxLength, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MAX_LENGTH_SCHEMA_DEFINITION__MAX_LENGTH, oldMaxLength, newMaxLength);
	...
	public void setMaxLength(NonNegativeInteger newMaxLength) {
		if (newMaxLength != maxLength) {
			...
			if (maxLength != null)
				msgs = ((InternalEObject)maxLength).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MAX_LENGTH_SCHEMA_DEFINITION__MAX_LENGTH, null, msgs);
			if (newMaxLength != null)
				msgs = ((InternalEObject)newMaxLength).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MAX_LENGTH_SCHEMA_DEFINITION__MAX_LENGTH, null, msgs);
			msgs = basicSetMaxLength(newMaxLength, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MAX_LENGTH_SCHEMA_DEFINITION__MAX_LENGTH, newMaxLength, newMaxLength));
	}
