 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.PropertyNamesSchemaDefinitionImpl#getPropertyNames <em>Property Names</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyNamesSchemaDefinitionImpl extends KeywordDefinitionImpl implements PropertyNamesSchemaDefinition {
	...
	public NotificationChain basicSetPropertyNames(Schema newPropertyNames, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.PROPERTY_NAMES_SCHEMA_DEFINITION__PROPERTY_NAMES, oldPropertyNames, newPropertyNames);
	...
	public void setPropertyNames(Schema newPropertyNames) {
		if (newPropertyNames != propertyNames) {
			...
			if (propertyNames != null)
				msgs = ((InternalEObject)propertyNames).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.PROPERTY_NAMES_SCHEMA_DEFINITION__PROPERTY_NAMES, null, msgs);
			if (newPropertyNames != null)
				msgs = ((InternalEObject)newPropertyNames).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.PROPERTY_NAMES_SCHEMA_DEFINITION__PROPERTY_NAMES, null, msgs);
			msgs = basicSetPropertyNames(newPropertyNames, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.PROPERTY_NAMES_SCHEMA_DEFINITION__PROPERTY_NAMES, newPropertyNames, newPropertyNames));
	}
