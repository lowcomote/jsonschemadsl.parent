 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.AdditionalItemsSchemaDefinitionImpl#getAdditionalItems <em>Additional Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalItemsSchemaDefinitionImpl extends KeywordDefinitionImpl implements AdditionalItemsSchemaDefinition {
	/**
	...
	public NotificationChain basicSetAdditionalItems(Schema newAdditionalItems, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ADDITIONAL_ITEMS_SCHEMA_DEFINITION__ADDITIONAL_ITEMS, oldAdditionalItems, newAdditionalItems);
	...
	public void setAdditionalItems(Schema newAdditionalItems) {
		if (newAdditionalItems != additionalItems) {
			...
			if (additionalItems != null)
				msgs = ((InternalEObject)additionalItems).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ADDITIONAL_ITEMS_SCHEMA_DEFINITION__ADDITIONAL_ITEMS, null, msgs);
			if (newAdditionalItems != null)
				msgs = ((InternalEObject)newAdditionalItems).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ADDITIONAL_ITEMS_SCHEMA_DEFINITION__ADDITIONAL_ITEMS, null, msgs);
			msgs = basicSetAdditionalItems(newAdditionalItems, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ADDITIONAL_ITEMS_SCHEMA_DEFINITION__ADDITIONAL_ITEMS, newAdditionalItems, newAdditionalItems));
	}
