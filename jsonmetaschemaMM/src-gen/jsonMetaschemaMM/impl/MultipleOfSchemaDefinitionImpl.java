 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.MultipleOfSchemaDefinitionImpl#getMultipleOf <em>Multiple Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultipleOfSchemaDefinitionImpl extends KeywordDefinitionImpl implements MultipleOfSchemaDefinition {
	...
	public void setMultipleOf(double newMultipleOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MULTIPLE_OF_SCHEMA_DEFINITION__MULTIPLE_OF, oldMultipleOf, multipleOf));
	}
