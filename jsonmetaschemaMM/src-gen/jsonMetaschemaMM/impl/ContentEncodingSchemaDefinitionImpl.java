 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.ContentEncodingSchemaDefinitionImpl#getContentEncoding <em>Content Encoding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentEncodingSchemaDefinitionImpl extends KeywordDefinitionImpl implements ContentEncodingSchemaDefinition {
	/**
	...
	public void setContentEncoding(String newContentEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.CONTENT_ENCODING_SCHEMA_DEFINITION__CONTENT_ENCODING, oldContentEncoding, contentEncoding));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case JsonMetaschemaMMPackage.CONTENT_ENCODING_SCHEMA_DEFINITION__CONTENT_ENCODING:
				return CONTENT_ENCODING_EDEFAULT == null ? contentEncoding != null : !CONTENT_ENCODING_EDEFAULT.equals(contentEncoding);
		}
