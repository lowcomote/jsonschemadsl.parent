 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.NotSchemaDefinitionImpl#getNot <em>Not</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotSchemaDefinitionImpl extends KeywordDefinitionImpl implements NotSchemaDefinition {
	...
	public NotificationChain basicSetNot(Schema newNot, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.NOT_SCHEMA_DEFINITION__NOT, oldNot, newNot);
	...
	public void setNot(Schema newNot) {
		if (newNot != not) {
			...
			if (not != null)
				msgs = ((InternalEObject)not).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.NOT_SCHEMA_DEFINITION__NOT, null, msgs);
			if (newNot != null)
				msgs = ((InternalEObject)newNot).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.NOT_SCHEMA_DEFINITION__NOT, null, msgs);
			msgs = basicSetNot(newNot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.NOT_SCHEMA_DEFINITION__NOT, newNot, newNot));
	}
