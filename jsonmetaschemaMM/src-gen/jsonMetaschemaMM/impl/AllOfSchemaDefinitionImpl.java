 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.AllOfSchemaDefinitionImpl#getAllOf <em>All Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllOfSchemaDefinitionImpl extends KeywordDefinitionImpl implements AllOfSchemaDefinition {
	...
	public NotificationChain basicSetAllOf(SchemaArray newAllOf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ALL_OF_SCHEMA_DEFINITION__ALL_OF, oldAllOf, newAllOf);
	...
	public void setAllOf(SchemaArray newAllOf) {
		if (newAllOf != allOf) {
			...
			if (allOf != null)
				msgs = ((InternalEObject)allOf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ALL_OF_SCHEMA_DEFINITION__ALL_OF, null, msgs);
			if (newAllOf != null)
				msgs = ((InternalEObject)newAllOf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ALL_OF_SCHEMA_DEFINITION__ALL_OF, null, msgs);
			msgs = basicSetAllOf(newAllOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ALL_OF_SCHEMA_DEFINITION__ALL_OF, newAllOf, newAllOf));
	}
