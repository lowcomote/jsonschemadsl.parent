 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.AnyOfSchemaDefinitionImpl#getAnyOf <em>Any Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnyOfSchemaDefinitionImpl extends KeywordDefinitionImpl implements AnyOfSchemaDefinition {
	...
	public NotificationChain basicSetAnyOf(SchemaArray newAnyOf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ANY_OF_SCHEMA_DEFINITION__ANY_OF, oldAnyOf, newAnyOf);
	...
	public void setAnyOf(SchemaArray newAnyOf) {
		if (newAnyOf != anyOf) {
			...
			if (anyOf != null)
				msgs = ((InternalEObject)anyOf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ANY_OF_SCHEMA_DEFINITION__ANY_OF, null, msgs);
			if (newAnyOf != null)
				msgs = ((InternalEObject)newAnyOf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ANY_OF_SCHEMA_DEFINITION__ANY_OF, null, msgs);
			msgs = basicSetAnyOf(newAnyOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ANY_OF_SCHEMA_DEFINITION__ANY_OF, newAnyOf, newAnyOf));
	}
