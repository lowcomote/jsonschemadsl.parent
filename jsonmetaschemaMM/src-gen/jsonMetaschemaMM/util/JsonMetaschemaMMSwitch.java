...
public class JsonMetaschemaMMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JsonMetaschemaMMPackage.OBJECT_SCHEMA: {
				...
				if (result == null) result = caseSchema(objectSchema);
			...
			case JsonMetaschemaMMPackage.MAXIMUM_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(maximumSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.WRITE_ONLY_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(writeOnlySchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.COMMENT_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(commentSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ENUM_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(enumSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.UNIQUE_ITEMS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(uniqueItemsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ANY_OF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(anyOfSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.TITLE_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(titleSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(itemsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.DEFAULT_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(defaultSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.THEN_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(thenSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.MIN_LENGTH_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(minLengthSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.DEFINITIONS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(definitionsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.MIN_ITEMS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(minItemsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ONE_OF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(oneOfSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.MAX_PROPERTIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(maxPropertiesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.MAX_ITEMS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(maxItemsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.FORMAT_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(formatSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.READ_ONLY_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(readOnlySchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(typeSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ADDITIONAL_PROPERTIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(additionalPropertiesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ELSE_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(elseSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ID_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(idSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.CONST_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(constSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.DEPENDENCIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(dependenciesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.REQUIRED_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(requiredSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.DESCRIPTION_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(descriptionSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.MIN_PROPERTIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(minPropertiesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.PATTERN_PROPERTIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(patternPropertiesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.EXAMPLES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(examplesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.IF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(ifSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.ALL_OF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(allOfSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.CONTENT_ENCODING_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(contentEncodingSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.MULTIPLE_OF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(multipleOfSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.PATTERN_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(patternSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.CONTAINS_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(containsSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.NOT_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(notSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.EXCLUSIVE_MAXIMUM_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(exclusiveMaximumSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.MAX_LENGTH_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(maxLengthSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.REF_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(refSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.CONTENT_MEDIA_TYPE_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(contentMediaTypeSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.EXCLUSIVE_MINIMUM_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(exclusiveMinimumSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.SCHEMA_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(schemaSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.PROPERTIES_SCHEMA_DEFINITION: {
				...
				if (result == null) result = caseKeywordDefinition(propertiesSchemaDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.BOOLEAN_SCHEMA: {
				...
				if (result == null) result = caseSchema(booleanSchema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.SCHEMA_OBJECT_ADDITIONAL_PROPERTIES: {
				...
				if (result == null) result = caseKeywordDefinition(schemaObjectAdditionalProperties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JsonMetaschemaMMPackage.SCHEMA_OBJECT_DEPENDENCIES_ADDITIONAL_PROPERTIES: {
				...
				if (result == null) result = caseSchemaObjectDependenciesProperties(schemaObjectDependenciesAdditionalProperties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.SCHEMA_OBJECT_DEPENDENCIES_ADDITIONAL_PROPERTIES_ANY_OF1: {
				...
				T result = caseSchemaObjectDependenciesAdditionalPropertiesAnyOf1(schemaObjectDependenciesAdditionalPropertiesAnyOf1);
				if (result == null) result = caseSchemaObjectDependenciesAdditionalPropertiesAnyOf(schemaObjectDependenciesAdditionalPropertiesAnyOf1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.SCHEMA_OBJECT_DEPENDENCIES_ADDITIONAL_PROPERTIES_ANY_OF2: {
				...
				T result = caseSchemaObjectDependenciesAdditionalPropertiesAnyOf2(schemaObjectDependenciesAdditionalPropertiesAnyOf2);
				if (result == null) result = caseSchemaObjectDependenciesAdditionalPropertiesAnyOf(schemaObjectDependenciesAdditionalPropertiesAnyOf2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsonMetaschemaMMPackage.SCHEMA_OBJECT_DEPENDENCIES_ADDITIONAL_PROPERTIES_ANY_OF: {
				...
				T result = caseSchemaObjectDependenciesAdditionalPropertiesAnyOf(schemaObjectDependenciesAdditionalPropertiesAnyOf);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSchemaObjectDependenciesAdditionalPropertiesAnyOf1(SchemaObjectDependenciesAdditionalPropertiesAnyOf1 object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSchemaObjectDependenciesAdditionalPropertiesAnyOf2(SchemaObjectDependenciesAdditionalPropertiesAnyOf2 object) {
		return null;
	}
