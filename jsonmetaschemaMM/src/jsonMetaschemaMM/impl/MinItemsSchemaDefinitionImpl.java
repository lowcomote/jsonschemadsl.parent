 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.MinItemsSchemaDefinitionImpl#getMinItems <em>Min Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MinItemsSchemaDefinitionImpl extends KeywordDefinitionImpl implements MinItemsSchemaDefinition {
	...
	public NotificationChain basicSetMinItems(NonNegativeIntegerDefault0 newMinItems, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MIN_ITEMS_SCHEMA_DEFINITION__MIN_ITEMS, oldMinItems, newMinItems);
	...
	public void setMinItems(NonNegativeIntegerDefault0 newMinItems) {
		if (newMinItems != minItems) {
			...
			if (minItems != null)
				msgs = ((InternalEObject)minItems).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_ITEMS_SCHEMA_DEFINITION__MIN_ITEMS, null, msgs);
			if (newMinItems != null)
				msgs = ((InternalEObject)newMinItems).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_ITEMS_SCHEMA_DEFINITION__MIN_ITEMS, null, msgs);
			msgs = basicSetMinItems(newMinItems, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MIN_ITEMS_SCHEMA_DEFINITION__MIN_ITEMS, newMinItems, newMinItems));
	}
