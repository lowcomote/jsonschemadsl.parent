 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.ExclusiveMinimumSchemaDefinitionImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExclusiveMinimumSchemaDefinitionImpl extends KeywordDefinitionImpl implements ExclusiveMinimumSchemaDefinition {
	/**
	...
	public void setExclusiveMinimum(double newExclusiveMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.EXCLUSIVE_MINIMUM_SCHEMA_DEFINITION__EXCLUSIVE_MINIMUM, oldExclusiveMinimum, exclusiveMinimum));
	}
