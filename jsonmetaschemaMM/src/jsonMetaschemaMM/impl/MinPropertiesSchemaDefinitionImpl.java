 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.impl.MinPropertiesSchemaDefinitionImpl#getMinProperties <em>Min Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MinPropertiesSchemaDefinitionImpl extends KeywordDefinitionImpl implements MinPropertiesSchemaDefinition {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMinProperties(NonNegativeIntegerDefault0 newMinProperties, NotificationChain msgs) {
		NonNegativeIntegerDefault0 oldMinProperties = minProperties;
		minProperties = newMinProperties;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MIN_PROPERTIES_SCHEMA_DEFINITION__MIN_PROPERTIES, oldMinProperties, newMinProperties);
	...
	public void setMinProperties(NonNegativeIntegerDefault0 newMinProperties) {
		if (newMinProperties != minProperties) {
			...
			if (minProperties != null)
				msgs = ((InternalEObject)minProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_PROPERTIES_SCHEMA_DEFINITION__MIN_PROPERTIES, null, msgs);
			if (newMinProperties != null)
				msgs = ((InternalEObject)newMinProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_PROPERTIES_SCHEMA_DEFINITION__MIN_PROPERTIES, null, msgs);
			msgs = basicSetMinProperties(newMinProperties, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.MIN_PROPERTIES_SCHEMA_DEFINITION__MIN_PROPERTIES, newMinProperties, newMinProperties));
	}
