 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.PatternPropertiesSchemaDefinition#getKeySchemaPairs <em>Key Schema Pairs</em>}</li>
 * </ul>
 *
 * @see jsonMetaschemaMM.jsonMetaschemaMM.JsonMetaschemaMMPackage#getPatternPropertiesSchemaDefinition()
 * @model
 * @generated
 */
public interface PatternPropertiesSchemaDefinition extends KeywordDefinition {
	 ...
	 * The list contents are of type {@link jsonMetaschemaMM.jsonMetaschemaMM.KeySchemaPair}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Key Schema Pairs</em>' containment reference list.
	 * @see jsonMetaschemaMM.jsonMetaschemaMM.JsonMetaschemaMMPackage#getPatternPropertiesSchemaDefinition_KeySchemaPairs()
