...
public class JsonMetaschemaMMFactoryImpl extends EFactoryImpl implements JsonMetaschemaMMFactory {
	...
	public static JsonMetaschemaMMFactory init() {
		try {
			JsonMetaschemaMMFactory theJsonMetaschemaMMFactory = (JsonMetaschemaMMFactory) EPackage.Registry.INSTANCE
					.getEFactory(JsonMetaschemaMMPackage.eNS_URI);
