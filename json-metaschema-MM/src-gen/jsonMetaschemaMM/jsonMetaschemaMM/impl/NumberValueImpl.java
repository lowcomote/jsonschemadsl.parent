 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.NumberValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberValueImpl extends ValueImpl implements NumberValue {
	...
	protected EClass eStaticClass() {
		return JsonMetaschemaMMPackage.Literals.NUMBER_VALUE;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.NUMBER_VALUE__VALUE, oldValue,
					value));
	}
