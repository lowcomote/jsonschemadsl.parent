 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.PatternPropertiesSchemaDefinitionImpl#getKeySchemaPairs <em>Key Schema Pairs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternPropertiesSchemaDefinitionImpl extends KeywordDefinitionImpl
		implements PatternPropertiesSchemaDefinition {
	/**
	...
	public EList<KeySchemaPair> getKeySchemaPairs() {
		if (keySchemaPairs == null) {
			keySchemaPairs = new EObjectContainmentEList<KeySchemaPair>(KeySchemaPair.class, this,
					JsonMetaschemaMMPackage.PATTERN_PROPERTIES_SCHEMA_DEFINITION__KEY_SCHEMA_PAIRS);
		}
