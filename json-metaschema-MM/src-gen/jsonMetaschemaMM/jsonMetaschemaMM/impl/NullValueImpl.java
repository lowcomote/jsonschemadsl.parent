 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.NullValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullValueImpl extends ValueImpl implements NullValue {
	 ...
	 * @ordered
	 */
	protected NullEnum value = VALUE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return JsonMetaschemaMMPackage.Literals.NULL_VALUE;
	}
	...
	public void setValue(NullEnum newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.NULL_VALUE__VALUE, oldValue,
					value));
	}
