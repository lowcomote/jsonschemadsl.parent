 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ContentMediaTypeSchemaDefinitionImpl#getContentMediaType <em>Content Media Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentMediaTypeSchemaDefinitionImpl extends KeywordDefinitionImpl
		implements ContentMediaTypeSchemaDefinition {
	/**
	...
	public void setContentMediaType(String newContentMediaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.CONTENT_MEDIA_TYPE_SCHEMA_DEFINITION__CONTENT_MEDIA_TYPE,
					oldContentMediaType, contentMediaType));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case JsonMetaschemaMMPackage.CONTENT_MEDIA_TYPE_SCHEMA_DEFINITION__CONTENT_MEDIA_TYPE:
			return CONTENT_MEDIA_TYPE_EDEFAULT == null ? contentMediaType != null
					: !CONTENT_MEDIA_TYPE_EDEFAULT.equals(contentMediaType);
		}
