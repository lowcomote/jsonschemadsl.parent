 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.MinLengthSchemaDefinitionImpl#getMinLength <em>Min Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MinLengthSchemaDefinitionImpl extends KeywordDefinitionImpl implements MinLengthSchemaDefinition {
	...
	public NotificationChain basicSetMinLength(NonNegativeIntegerDefault0 newMinLength, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MIN_LENGTH_SCHEMA_DEFINITION__MIN_LENGTH, oldMinLength, newMinLength);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMinLength(NonNegativeIntegerDefault0 newMinLength) {
		if (newMinLength != minLength) {
			...
			if (minLength != null)
				msgs = ((InternalEObject) minLength).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_LENGTH_SCHEMA_DEFINITION__MIN_LENGTH, null,
						msgs);
			if (newMinLength != null)
				msgs = ((InternalEObject) newMinLength).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MIN_LENGTH_SCHEMA_DEFINITION__MIN_LENGTH, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MIN_LENGTH_SCHEMA_DEFINITION__MIN_LENGTH, newMinLength, newMinLength));
	}
