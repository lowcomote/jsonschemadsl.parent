 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ContainsSchemaDefinitionImpl#getContains <em>Contains</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetContains(Schema newContains, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.CONTAINS_SCHEMA_DEFINITION__CONTAINS, oldContains, newContains);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newContains != contains) {
			...
			if (contains != null)
				msgs = ((InternalEObject) contains).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.CONTAINS_SCHEMA_DEFINITION__CONTAINS, null,
						msgs);
			if (newContains != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.CONTAINS_SCHEMA_DEFINITION__CONTAINS, newContains, newContains));
	}
