 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.MaxPropertiesSchemaDefinitionImpl#getMaxProperties <em>Max Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetMaxProperties(NonNegativeInteger newMaxProperties, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MAX_PROPERTIES_SCHEMA_DEFINITION__MAX_PROPERTIES, oldMaxProperties,
					newMaxProperties);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMaxProperties(NonNegativeInteger newMaxProperties) {
		if (newMaxProperties != maxProperties) {
			...
			if (maxProperties != null)
				msgs = ((InternalEObject) maxProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- JsonMetaschemaMMPackage.MAX_PROPERTIES_SCHEMA_DEFINITION__MAX_PROPERTIES, null, msgs);
			if (newMaxProperties != null)
				msgs = ((InternalEObject) newMaxProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- JsonMetaschemaMMPackage.MAX_PROPERTIES_SCHEMA_DEFINITION__MAX_PROPERTIES, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MAX_PROPERTIES_SCHEMA_DEFINITION__MAX_PROPERTIES, newMaxProperties,
					newMaxProperties));
	}
