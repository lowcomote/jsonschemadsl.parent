 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.TypeSchemaDefinitionImpl#getTypeAnyOf1 <em>Type Any Of1</em>}</li>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.TypeSchemaDefinitionImpl#getTypesAnyOf2 <em>Types Any Of2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeSchemaDefinitionImpl extends KeywordDefinitionImpl implements TypeSchemaDefinition {
	...
	public void setTypeAnyOf1(SimpleTypes newTypeAnyOf1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION__TYPE_ANY_OF1, oldTypeAnyOf1, typeAnyOf1));
	}
	...
	public NotificationChain basicSetTypesAnyOf2(TypesAnyOf2 newTypesAnyOf2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION__TYPES_ANY_OF2, oldTypesAnyOf2, newTypesAnyOf2);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypesAnyOf2(TypesAnyOf2 newTypesAnyOf2) {
		if (newTypesAnyOf2 != typesAnyOf2) {
			...
			if (typesAnyOf2 != null)
				msgs = ((InternalEObject) typesAnyOf2).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION__TYPES_ANY_OF2, null,
						msgs);
			if (newTypesAnyOf2 != null)
				msgs = ((InternalEObject) newTypesAnyOf2).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION__TYPES_ANY_OF2, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.TYPE_SCHEMA_DEFINITION__TYPES_ANY_OF2, newTypesAnyOf2, newTypesAnyOf2));
	}
