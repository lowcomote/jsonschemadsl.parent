 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.OneOfSchemaDefinitionImpl#getOneOf <em>One Of</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetOneOf(SchemaArray newOneOf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ONE_OF_SCHEMA_DEFINITION__ONE_OF, oldOneOf, newOneOf);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOneOf != oneOf) {
			...
			if (oneOf != null)
				msgs = ((InternalEObject) oneOf).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ONE_OF_SCHEMA_DEFINITION__ONE_OF, null, msgs);
			if (newOneOf != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ONE_OF_SCHEMA_DEFINITION__ONE_OF, newOneOf, newOneOf));
	}
