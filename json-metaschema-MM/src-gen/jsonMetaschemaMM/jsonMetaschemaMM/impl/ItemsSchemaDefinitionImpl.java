 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ItemsSchemaDefinitionImpl#getItemsAnyOf1 <em>Items Any Of1</em>}</li>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ItemsSchemaDefinitionImpl#getItemsAnyOf2 <em>Items Any Of2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemsSchemaDefinitionImpl extends KeywordDefinitionImpl implements ItemsSchemaDefinition {
	...
	public NotificationChain basicSetItemsAnyOf1(Schema newItemsAnyOf1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF1, oldItemsAnyOf1, newItemsAnyOf1);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setItemsAnyOf1(Schema newItemsAnyOf1) {
		if (newItemsAnyOf1 != itemsAnyOf1) {
			...
			if (itemsAnyOf1 != null)
				msgs = ((InternalEObject) itemsAnyOf1).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF1, null,
						msgs);
			if (newItemsAnyOf1 != null)
				msgs = ((InternalEObject) newItemsAnyOf1).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF1, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF1, newItemsAnyOf1, newItemsAnyOf1));
	}
	...
	public NotificationChain basicSetItemsAnyOf2(SchemaArray newItemsAnyOf2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF2, oldItemsAnyOf2, newItemsAnyOf2);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setItemsAnyOf2(SchemaArray newItemsAnyOf2) {
		if (newItemsAnyOf2 != itemsAnyOf2) {
			NotificationChain msgs = null;
			if (itemsAnyOf2 != null)
				msgs = ((InternalEObject) itemsAnyOf2).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF2, null,
						msgs);
			if (newItemsAnyOf2 != null)
				msgs = ((InternalEObject) newItemsAnyOf2).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF2, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ITEMS_SCHEMA_DEFINITION__ITEMS_ANY_OF2, newItemsAnyOf2, newItemsAnyOf2));
	}
