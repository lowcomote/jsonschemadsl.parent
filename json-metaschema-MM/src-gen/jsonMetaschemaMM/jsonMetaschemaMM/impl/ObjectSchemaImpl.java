 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ObjectSchemaImpl#getKeywordDefinition <em>Keyword Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectSchemaImpl extends SchemaImpl implements ObjectSchema {
	...
	public EList<KeywordDefinition> getKeywordDefinition() {
		if (keywordDefinition == null) {
			keywordDefinition = new EObjectContainmentEList<KeywordDefinition>(KeywordDefinition.class, this,
					JsonMetaschemaMMPackage.OBJECT_SCHEMA__KEYWORD_DEFINITION);
		}
