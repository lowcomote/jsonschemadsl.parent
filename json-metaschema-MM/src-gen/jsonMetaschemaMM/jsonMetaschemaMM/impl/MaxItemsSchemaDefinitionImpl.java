 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.MaxItemsSchemaDefinitionImpl#getMaxItems <em>Max Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaxItemsSchemaDefinitionImpl extends KeywordDefinitionImpl implements MaxItemsSchemaDefinition {
	...
	public NotificationChain basicSetMaxItems(NonNegativeInteger newMaxItems, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MAX_ITEMS_SCHEMA_DEFINITION__MAX_ITEMS, oldMaxItems, newMaxItems);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMaxItems(NonNegativeInteger newMaxItems) {
		if (newMaxItems != maxItems) {
			...
			if (maxItems != null)
				msgs = ((InternalEObject) maxItems).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MAX_ITEMS_SCHEMA_DEFINITION__MAX_ITEMS, null,
						msgs);
			if (newMaxItems != null)
				msgs = ((InternalEObject) newMaxItems).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.MAX_ITEMS_SCHEMA_DEFINITION__MAX_ITEMS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.MAX_ITEMS_SCHEMA_DEFINITION__MAX_ITEMS, newMaxItems, newMaxItems));
	}
