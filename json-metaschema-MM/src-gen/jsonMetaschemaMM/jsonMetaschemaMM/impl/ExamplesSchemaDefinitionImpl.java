 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ExamplesSchemaDefinitionImpl#getExamples <em>Examples</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExamplesSchemaDefinitionImpl extends KeywordDefinitionImpl implements ExamplesSchemaDefinition {
	...
	public EList<JsonDocument> getExamples() {
		if (examples == null) {
			examples = new EObjectContainmentEList<JsonDocument>(JsonDocument.class, this,
					JsonMetaschemaMMPackage.EXAMPLES_SCHEMA_DEFINITION__EXAMPLES);
		}
		return examples;
	}
