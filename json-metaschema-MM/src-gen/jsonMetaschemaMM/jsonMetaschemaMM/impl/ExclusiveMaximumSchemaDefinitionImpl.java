 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ExclusiveMaximumSchemaDefinitionImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExclusiveMaximumSchemaDefinitionImpl extends KeywordDefinitionImpl
		implements ExclusiveMaximumSchemaDefinition {
	/**
	...
	public void setExclusiveMaximum(double newExclusiveMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.EXCLUSIVE_MAXIMUM_SCHEMA_DEFINITION__EXCLUSIVE_MAXIMUM, oldExclusiveMaximum,
					exclusiveMaximum));
	}
