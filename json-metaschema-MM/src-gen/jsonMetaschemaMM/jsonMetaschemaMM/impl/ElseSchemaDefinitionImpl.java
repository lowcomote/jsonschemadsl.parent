 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ElseSchemaDefinitionImpl#getElse <em>Else</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetElse(Schema newElse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.ELSE_SCHEMA_DEFINITION__ELSE, oldElse, newElse);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newElse != else_) {
			...
			if (else_ != null)
				msgs = ((InternalEObject) else_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.ELSE_SCHEMA_DEFINITION__ELSE, null, msgs);
			if (newElse != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JsonMetaschemaMMPackage.ELSE_SCHEMA_DEFINITION__ELSE,
					newElse, newElse));
	}
