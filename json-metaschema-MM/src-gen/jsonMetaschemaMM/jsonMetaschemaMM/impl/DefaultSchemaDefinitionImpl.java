 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.DefaultSchemaDefinitionImpl#getDefault <em>Default</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetDefault(JsonDocument newDefault, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.DEFAULT_SCHEMA_DEFINITION__DEFAULT, oldDefault, newDefault);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject) default_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.DEFAULT_SCHEMA_DEFINITION__DEFAULT, null,
						msgs);
			if (newDefault != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.DEFAULT_SCHEMA_DEFINITION__DEFAULT, newDefault, newDefault));
	}
