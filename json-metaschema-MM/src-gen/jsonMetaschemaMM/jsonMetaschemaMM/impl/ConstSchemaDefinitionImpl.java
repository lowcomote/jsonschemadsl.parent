 ...
 * </p>
 * <ul>
 *   <li>{@link jsonMetaschemaMM.jsonMetaschemaMM.impl.ConstSchemaDefinitionImpl#getConst <em>Const</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetConst(JsonDocument newConst, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.CONST_SCHEMA_DEFINITION__CONST, oldConst, newConst);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConst != const_) {
			...
			if (const_ != null)
				msgs = ((InternalEObject) const_).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JsonMetaschemaMMPackage.CONST_SCHEMA_DEFINITION__CONST, null, msgs);
			if (newConst != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					JsonMetaschemaMMPackage.CONST_SCHEMA_DEFINITION__CONST, newConst, newConst));
	}
