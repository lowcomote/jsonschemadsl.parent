...
/**
 * This is the item provider adapter for a {@link jsonMetaschemaMM.TypeSchemaDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeSchemaDefinitionItemProvider extends KeywordDefinitionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeSchemaDefinition_typeAnyOf1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeSchemaDefinition_typeAnyOf1_feature", "_UI_TypeSchemaDefinition_type"),
				 JsonMetaschemaMMPackage.Literals.TYPE_SCHEMA_DEFINITION__TYPE_ANY_OF1,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TypeSchemaDefinition_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsonMetaschemaMMPackage.Literals.TYPE_SCHEMA_DEFINITION__TYPES_ANY_OF2,
