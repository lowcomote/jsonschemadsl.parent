...
/**
 * This is the item provider adapter for a {@link jsonMetaschemaMM.SchemaSchemaDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaSchemaDefinitionItemProvider extends KeywordDefinitionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SchemaSchemaDefinition_schema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SchemaSchemaDefinition_schema_feature", "_UI_SchemaSchemaDefinition_type"),
				 JsonMetaschemaMMPackage.Literals.SCHEMA_SCHEMA_DEFINITION__SCHEMA,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SchemaSchemaDefinition_type") :
