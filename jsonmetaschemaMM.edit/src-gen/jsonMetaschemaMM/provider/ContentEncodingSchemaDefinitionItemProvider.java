...
/**
 * This is the item provider adapter for a {@link jsonMetaschemaMM.ContentEncodingSchemaDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContentEncodingSchemaDefinitionItemProvider extends KeywordDefinitionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContentEncodingSchemaDefinition_contentEncoding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContentEncodingSchemaDefinition_contentEncoding_feature", "_UI_ContentEncodingSchemaDefinition_type"),
				 JsonMetaschemaMMPackage.Literals.CONTENT_ENCODING_SCHEMA_DEFINITION__CONTENT_ENCODING,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ContentEncodingSchemaDefinition_type") :
