...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="16:12-16:19"/>
		<constant value="16:4-16:19"/>
		<constant value="19:4-19:14"/>
		<constant value="19:31-19:39"/>
		<constant value="19:4-19:40"/>
		<constant value="18:3-20:4"/>
		<constant value="link"/>
		<constant value="__matchObjectSchemaToEClass"/>
		<constant value="ObjectSchema"/>
		<constant value="J.isTypeObject():J"/>
		<constant value="B.not():B"/>
		<constant value="31"/>
		<constant value="objectSchema"/>
		<constant value="eClass"/>
		<constant value="EClass"/>
		<constant value="26:34-26:46"/>
		<constant value="26:34-26:61"/>
		<constant value="29:3-29:22"/>
		<constant value="__applyObjectSchemaToEClass"/>
		<constant value="eClassifiers"/>
		<constant value="31:3-31:13"/>
		<constant value="31:3-31:26"/>
		<constant value="31:42-31:48"/>
		<constant value="31:3-31:49"/>
		<constant value="30:2-32:3"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	<field name="5" type="4"/>
	...
	<operation name="79">
		...
		<linenumbertable>
			...
			<lne id="89" begin="23" end="28"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="84" begin="6" end="30"/>
	...
	<operation name="90">
		...
		<linenumbertable>
			...
			<lne id="95" begin="10" end="13"/>
			<lne id="96" begin="10" end="13"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="85" begin="7" end="13"/>
			<lve slot="2" name="84" begin="3" end="13"/>
